...
func TestTwoSumHash(t *testing.T) {
	input := []int{2, 7, 11, 15}
	fmt.Println(TwoSumHash(input, 9))
	fmt.Println(TwoSumHash(input, 18))
	fmt.Println(TwoSumHash(input, 26))
	fmt.Println(TwoSumHash(input, 22))

	fmt.Println("negative cases")

	input = []int{-1, -2, -3, 5}
	fmt.Println(TwoSumHash(input, -3))
	fmt.Println(TwoSumHash(input, -5))
	fmt.Println(TwoSumHash(input, 3))
}
